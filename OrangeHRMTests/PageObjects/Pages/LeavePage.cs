...
namespace OrangeHRMTests.PageObjects.Pages
{
    public class LeavePage : BasePage
    {
        ...
        private MyWebElement FromDateCalendarValueButton = new MyWebElement(By.XPath("//*[text()='From Date']//ancestor::div[1]//following-sibling::div[1]//div[@class='oxd-calendar-dates-grid']//*[text()='26']"));
        private MyWebElement ToDateCalendarValueButton = new MyWebElement(By.XPath("//*[text()='To Date']//ancestor::div[1]//following-sibling::div[1]//div[@class='oxd-calendar-dates-grid']//*[text()='27']"));
